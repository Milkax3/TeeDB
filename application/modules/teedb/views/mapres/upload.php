...
<?php if(isset($submit) && $submit===true): ?>
	<div class="dialog-info" class="ui-widget" id="info">
		<div class="ui-state-highlight ui-corner-all" style="padding: 0pt 0.7em;">
			<p><span style="float: left; margin-right: 0.3em;" class="ui-icon ui-icon-info"></span>
				Your Mapres was sucsessfully uploaded.
			</p>
		</div>
	</div>
	<br>
...
<?php echo form_hidden('file_size',$upload_data['file_size']); ?>
	...
	<br><br>
	<img src="<?php echo base_url()."upload/mapress/previews/".$upload_data['raw_name']; ?>.png" alt="Preview" style="float:left;">
	...
	<br style="clear: both;" />
	<?php /*
	<div style="width:256px; height:128px; margin: auto;">
		<img src="<?php echo base_url()."upload/mapress/".$upload_data['raw_name']; ?>.png" width="256" alt="Skin">
	</div>
	<br style="clear: both;" />
	 */ ?>
<?php endif; ?>