...
class News extends CI_Controller {
	...
	public function submit()
	{
		...
		return $this->_info('Comment added.');
	}

	private function _submit_validate()
	{
		$this->form_validation->set_rules('id', 'id', 'trim|required|is_natural_no_zero||exists[blog.id]');
		$this->form_validation->set_rules('comment', 'comment text', 'trim|required|min_length[10]|max_length[140]|unique[comments.comment]|no_spam[comments.3]');
