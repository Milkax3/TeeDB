...
class Migration_TeeDB_Gameskin extends CI_Migration {
	
	function up() 
	{	
		if ( ! $this->db->table_exists('teedb_gameskin'))
		{
			// Setup Keys
			...
			$this->dbforge->create_table('teedb_gameskin', TRUE);
		}
	}

	function down() 
	{
		$this->dbforge->drop_table('teedb_gameskin');
	}
}