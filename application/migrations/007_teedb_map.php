...
class Migration_TeeDB_Map extends CI_Migration {
	
	function up() 
	{	
		if ( ! $this->db->table_exists('teedb_map'))
		{
			// Setup Keys
			...
			$this->dbforge->create_table('teedb_map', TRUE);
		}
	}

	function down() 
	{
		$this->dbforge->drop_table('teedb_map');
	}
}