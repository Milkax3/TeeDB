...
class Migration_TeeDB_Mod extends CI_Migration {
	
	function up() 
	{	
		if ( ! $this->db->table_exists('teedb_mod'))
		{
			// Setup Keys
			...
			$this->dbforge->create_table('teedb_mod', TRUE);
		}
	}

	function down() 
	{
		$this->dbforge->drop_table('teedb_mod');
	}
}